...
Get-MigrationReport -CSVFolder "C:\CSV" -ProjectKey "Acme" `
    -CountryCode "ES1" -Domain "amorim.rocks"
```
...
- Example: `ES1-invoices@amorim.rocks` (from source `invoices@acme.com` with CountryCode `ES1`)
...
Import-AllSharedMailboxes -CSVFile "C:\CSV\Acme\Shared_Mailboxes_Acme.csv" `
    -CountryCode "ES1" -Company "Acme" -Domain "amorim.rocks" -WhatIf
```
